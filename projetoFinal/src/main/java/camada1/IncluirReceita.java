...
public class IncluirReceita extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SALARIO", "DECIMO_TERCEIRO", "FERIAS", "TIGRINHO", "OUTRAS" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        receita = IncluirReceita();
        setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    public Receita receita;
    
    public Receita IncluirReceita() {
        try {
            ...
            Receita receitaa = new Receita(valor, data, categoria);
